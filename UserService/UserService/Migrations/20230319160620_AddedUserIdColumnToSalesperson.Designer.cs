...
namespace CarAuto.UserService.Migrations
{
    ...
    [Migration("20230319160620_AddedUserIdColumnToSalesperson")]
    partial class AddedUserIdColumnToSalesperson
    {
            ...
            modelBuilder.Entity("CarAuto.UserService.DAL.Entities.Salesperson", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_salespersons_user_id");
            ...
            modelBuilder.Entity("CarAuto.UserService.DAL.Entities.Salesperson", b =>
                {
                    b.HasOne("CarAuto.UserService.DAL.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_salespersons_users_user_id");
