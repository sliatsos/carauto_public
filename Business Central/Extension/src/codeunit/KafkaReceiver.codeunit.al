codeunit 50100 "CAR Kafka Receiver"
{
    var
    ...
    begin
        ...
        JArrayL.Add(SalesIntegrSetupL."Consumer Topic");
    ...
    begin
        ...
        if IsNullGuid(IntegrationSetupL."Consumer Instance Id") then begin
            IntegrationSetupL."Consumer Instance Id" := HelperG.GuidToJson(CreateGuid());
            IntegrationSetupL."Consumer Id" := HelperG.GuidToJson(CreateGuid());
            IntegrationSetupL.Modify();
        end;
        JObjectL.Add('name', IntegrationSetupL."Consumer Id");
        JObjectL.Add('format', 'json');
        JObjectL.Add('auto.offset.reset', 'earliest');
        UrlL := StrSubstNo('%1/%2/%3', IntegrationSetupL."Base URI", 'consumers', IntegrationSetupL."Consumer Instance Id");
    ...
    begin
        IntegrationSetupL.Get();
        IntegrationSetupL.TestField("Consumer Instance Id");
        IntegrationSetupL.TestField("Consumer Id");
        UrlL := StrSubstNo('%1/%2/%3', IntegrationSetupL."Base URI", 'consumers', IntegrationSetupL."Consumer Instance Id");
        UrlL := StrSubstNo('%1/%2/%3', UrlL, 'instances', IntegrationSetupL."Consumer Id");
