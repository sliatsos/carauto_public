tableextension 50101 "CAR Sales Invoice Header" extends "Sales Invoice Header"
{
    fields
    {
        ...
        field(50108; "CAR Model Description"; Text[50])
        {
            Caption = 'Registration Date';
            DataClassification = CustomerContent;
        }
        ...
        field(50113; "CAR Order Id"; Guid)
        {
            Caption = 'Order Id';
            DataClassification = CustomerContent;
        }
        field(50120; "CAR Invoice Pdf"; Media)
        {
            Caption = 'Invoice Pdf';
            DataClassification = CustomerContent;
        }
